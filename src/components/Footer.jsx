...
export default function Footer() {
  ...
  const ctaTitle = "Ready to start your project?";
  const ctaSubtitle = "Let's work together to build something great.";
    ...
    <>
      <section className="bg-brand-orange py-10 md:py-12">
          <div className="max-w-7xl mx-auto p-2 md:px-9 text-center">
              ...
              {ctaSubtitle && (
                  <p className="mx-auto mt-3 max-w-2xl text-sm text-white/90">{ctaSubtitle}</p>
              )}
          </div>
      </section>
